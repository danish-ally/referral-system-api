...
describe('getUserdata', () => {
  ...
  it('should retrieve sales caller list with valid authorization token', (done) => {
    ...
    chai
      .request(app)
      .get('/api/v1/external/getUserdata')
      .set('authorization', mockToken)
      .end((err, res) => {
        res.should.have.status(200);
        res.body.should.be.an('object');
        res.body.error.should.be.false;
        res.body.message.should.equal('got sales caller list successfully');
