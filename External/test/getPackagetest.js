...
describe('getPackageByChannel', () => {

  it('should retrieve packages for a channel', (done) => {
    const mockChannelId = '1';
    chai
      .request(app)
      .get('/api/v1/external/getpackage')
      .set('channelid', mockChannelId)
      .end((err, res) => {
        res.should.have.status(200);
        res.body.should.be.an('object');
        res.body.error.should.be.false;
        res.body.message.should.equal('got package list successfully');
